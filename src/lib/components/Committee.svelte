<script lang="ts">
    ...
    const members = [
        ...
        {name: "Arda Koç", functions: ["External Affairs"], linkedin: "https://www.linkedin.com/in/ardakocm/", email: "external@availabilit.snic.nl", picture: Arda},
        {name: "Mariska Frelier", functions: ["External Affairs"], linkedin: "https://www.linkedin.com/in/mariska-frelier/", email: "external@availabilit.snic.nl", picture: Mariska},
